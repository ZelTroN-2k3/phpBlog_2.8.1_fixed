    ...
    if (isset($_POST['edit'])) {
        ...
        switch ($widget_type) {
            ...
            case 'faq_leaderboard':
                // Ces types n'ont besoin d'aucune configuration
                break;
        
            case 'testimonials':
                $widget_name = 'Slider Testimonials';
                ...
                <form action="widgets.php?edit-id=<?php echo $id; ?><?php echo $status_url_param; ?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="alert alert-light">
                            <strong>Widget type:</strong> <?php echo $widget_name; ?> (Not editable)
                        </div>
                        ...
                        ?>
                                <div class="alert alert-info">
                                    This widget does not require any additional configuration.
                                </div>
                        <?php 
                                break; 
...
foreach ($widgets as $row) {
    ...
    switch($row['widget_type']) {
        ...
        case 'quiz_leaderboard': $type_name = 'Quiz Leaderboard'; $type_icon = 'fa-trophy'; break;
        case 'faq_leaderboard': $type_name = 'FAQ Leaderboard'; $type_icon = 'fa-question-circle'; break;
        case 'testimonials': $type_name = 'Témoignages'; $type_icon = 'fa-comments'; break;
    }
