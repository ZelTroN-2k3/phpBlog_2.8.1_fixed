...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Pages du Footer</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="dashboard.php">Accueil</a></li>
                    <li class="breadcrumb-item active">Pages Footer</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Gérer le contenu des 5 pages fixes du Footer</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['active'] == 'Yes') : ?>
                                                <a href="footer_pages.php?deactivate-id=<?php echo $row['id']; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-warning btn-sm" title="Désactiver">
                                                    <i class="fas fa-toggle-off"></i>
                                                </a>
                                            <?php else : ?>
                                                <a href="footer_pages.php?activate-id=<?php echo $row['id']; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-success btn-sm" title="Activer">
                                                    <i class="fas fa-toggle-on"></i>
                                                </a>
                                            <?php endif; ?>

                                            <a href="edit_footer_page.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm" title="Modifier">
