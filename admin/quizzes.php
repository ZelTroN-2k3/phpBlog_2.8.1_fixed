        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="dashboard.php">Welcome</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="add_quiz.php" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Create New Quiz</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['active'] == 'Yes') : ?>
                                                <a href="quizzes.php?deactivate-id=<?php echo $row['id']; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-warning btn-sm" title="DDeactivate"><i class="fas fa-toggle-off"></i></a>
                                            <?php else : ?>
                                                <a href="quizzes.php?activate-id=<?php echo $row['id']; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-success btn-sm" title="Activate"><i class="fas fa-toggle-on"></i></a>
                                            <?php endif; ?>

                                            <a href="edit_quiz.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm" title="Edit Quiz"><i class="fas fa-edit"></i></a>
                                            
                                            <a href="quizzes.php?delete-id=<?php echo $row['id']; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this Quiz AND all its associated questions and answers?');" title="Delete Quiz">
