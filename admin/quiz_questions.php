    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <small class="text-muted">For the quiz: <?php echo htmlspecialchars($quiz_title); ?></small>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Questions for "<?php echo htmlspecialchars($quiz_title); ?>"</h3>
                        <a href="add_question.php?quiz_id=<?php echo $quiz_id; ?>" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Add Question</a>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row['active'] == 'Yes') : ?>
                                                <a href="quiz_questions.php?deactivate-id=<?php echo $row['id']; ?>&quiz_id=<?php echo $quiz_id; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-warning btn-sm" title="DDeactivate">
                                                    <i class="fas fa-toggle-off"></i>
                                                </a>
                                            <?php else : ?>
                                                <a href="quiz_questions.php?activate-id=<?php echo $row['id']; ?>&quiz_id=<?php echo $quiz_id; ?>&token=<?php echo $csrf_token; ?>" class="btn btn-success btn-sm" title="Activate">
                                                    <i class="fas fa-toggle-on"></i>
                                                </a>
                                            <?php endif; ?>

                                            <a href="edit_question.php?id=<?php echo $row['id']; ?>&quiz_id=<?php echo $quiz_id; ?>" class="btn btn-info btn-sm" title="Edit">
