...
$count_drafts_pending = $count_posts_drafts; // Correction ici
...
$q_polls_pending = mysqli_query($connect, "SELECT COUNT(id) as count FROM polls WHERE active = 'No'");
$count_polls_pending = mysqli_fetch_assoc($q_polls_pending)['count'];
// Slides
$q_slides = mysqli_query($connect, "SELECT COUNT(id) as count FROM slides");
$count_slides_total = mysqli_fetch_assoc($q_slides)['count'];
$q_slides_pending = mysqli_query($connect, "SELECT COUNT(id) as count FROM slides WHERE active = 'No'");
$count_slides_pending = mysqli_fetch_assoc($q_slides_pending)['count'];
// FAQ
$q_faq = mysqli_query($connect, "SELECT COUNT(id) as count FROM faqs");
$count_faq_total = mysqli_fetch_assoc($q_faq)['count'];
$q_faq_pending = mysqli_query($connect, "SELECT COUNT(id) as count FROM faqs WHERE active = 'No'");
$count_faq_pending = mysqli_fetch_assoc($q_faq_pending)['count'];
// QUIZ 
$q_quiz_total = mysqli_query($connect, "SELECT COUNT(id) as count FROM quizzes");
$count_quiz_total = mysqli_fetch_assoc($q_quiz_total)['count'];
$q_quiz_pending = mysqli_query($connect, "SELECT COUNT(id) as count FROM quizzes WHERE active = 'No'");
$count_quiz_pending = mysqli_fetch_assoc($q_quiz_pending)['count'];
// Bans (Bannissements)
$count_bans = 0;
// On vérifie si la table existe pour éviter une erreur si le SQL n'a pas été importé
if ($user['role'] == "Admin") {
    $q_bans = mysqli_query($connect, "SELECT COUNT(id) as count FROM bans WHERE active = 'Yes'");
    if ($q_bans) {
        $count_bans = mysqli_fetch_assoc($q_bans)['count'];
    }
}
                ...
                <a href="polls.php" style="color: inherit; text-decoration: none;">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo $count_polls_total; ?>
                                <?php if($count_polls_pending > 0) echo "<small class='badge bg-danger'>{$count_polls_pending} new</small>"; ?>
                            </span>
                        </div>
                    </div>
                </a>
                ...
                <a href="slides.php" style="color: inherit; text-decoration: none;">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo $count_slides_total; ?>
                                <?php if($count_slides_pending > 0) echo "<small class='badge bg-danger'>{$count_slides_pending} new</small>"; ?>
                            </span>
                        </div>
                    </div>
                </a>
                ...
                <a href="faq.php" style="color: inherit; text-decoration: none;">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo $count_faq_total; ?>
                                <?php if($count_faq_pending > 0) echo "<small class='badge bg-danger'>{$count_faq_pending} new</small>"; ?>
                            </span>    
                        </div>
                    </div>
                </a>
                ...
                <a href="quizzes.php" style="color: inherit; text-decoration: none;">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo $count_quiz_total; ?>
                                <?php if($count_quiz_pending > 0) echo "<small class='badge bg-danger'>{$count_quiz_pending} new</small>"; ?>
                            </span>
                        </div>
                    </div>
                </a>
