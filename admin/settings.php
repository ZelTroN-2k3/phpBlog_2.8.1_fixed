                    ...
                    <div class="card card-primary card-outline card-tabs">
                        ...
                        <div class="card-body tab-content" id="custom-tabs-settings-content">
                            ...
                            <div class="tab-pane fade" id="tab-security" role="tabpanel" aria-labelledby="tab-security-link">
                                ...
                                <hr>
                                <h4><i class="fas fa-code"></i> Intégration de Code Personnalisé</h4>
                                <div class="form-group">
                                    <label><i class="fas fa-code text-warning"></i> Code personnalisé (Head)</label>
                                    ...
                                    <small class="text-muted">Ajoute du code (ex: Google Analytics) juste avant la balise `&lt;/head&gt;`.</small>
                                </div>
                                <div class="form-group">
                                    <label><i class="fas fa-toggle-on text-success"></i> Activer le code personnalisé</label>
                        ...
                        <div class="card-footer">
                            <button type="submit" name="save" class="btn btn-primary"><i class="fas fa-save"></i> Enregistrer les modifications</button>
                        </div>
