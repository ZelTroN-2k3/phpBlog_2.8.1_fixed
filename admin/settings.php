...
if (isset($_POST['save'])) {
    ...
    // --- LOGIQUE UPLOAD LOGO ---
    $new_site_logo = $settings['site_logo']; // Par défaut, on garde l'ancien
    ...
    if ($uploadOk == 1) {
        ...
        try {
            ...
            $sql = "UPDATE settings SET 
                            ...
                            sticky_header = ?, google_maps_code = ?, site_logo = ? -- <--- CHAMP AJOUTÉ
                        WHERE id = 1";
            ...
            // 2. Définir les types (maintenant 32 colonnes = 32 's')
            $types = "ssssssssssssssssssssssssssssssss"; // 32 's'
            
            // 3. Encoder le 'head_customcode' en base64
            $head_customcode_encoded = base64_encode($_POST['head_customcode']);
            $google_maps_encoded = base64_encode($_POST['google_maps_code']); // Encodage Map
                    ...
                    <div class="card card-primary card-outline card-tabs">
                        ...
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-settings" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="tab-general-link" data-toggle="pill" href="#tab-general" role="tab" aria-controls="tab-general" aria-selected="true"><i class="fas fa-tools"></i> Général</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-layout-link" data-toggle="pill" href="#tab-layout" role="tab" aria-controls="tab-layout" aria-selected="false"><i class="fas fa-palette"></i> Apparence & Layout</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-seo-link" data-toggle="pill" href="#tab-seo" role="tab" aria-controls="tab-seo" aria-selected="false"><i class="fas fa-chart-line"></i> SEO & Social</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-security-link" data-toggle="pill" href="#tab-security" role="tab" aria-controls="tab-security" aria-selected="false"><i class="fas fa-shield-alt"></i> Intégrations & Sécurité</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body tab-content" id="custom-tabs-settings-content">
                            ...
                            <div class="tab-pane fade" id="tab-layout" role="tabpanel" aria-labelledby="tab-layout-link">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><i class="fas fa-thumbtack text-primary"></i> Sticky Header</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><i class="fas fa-grip-horizontal text-primary"></i> Posts per row (Home)</label>
                                            <select name="posts_per_row" class="form-control" required>
                                                <option value="2" <?php if ($settings['posts_per_row'] == "2") { echo 'selected'; } ?>>2</option>
                                                <option value="3" <?php if ($settings['posts_per_row'] == "3") { echo 'selected'; } ?>>3</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><i class="fas fa-newspaper text-primary"></i> Barre "Latest News"</label>
                                            <select name="latestposts_bar" class="form-control" required>
                                                <option value="Enabled" <?php if ($settings['latestposts_bar'] == 'Enabled') echo 'selected'; ?>>On (Afficher)</option>
                                                <option value="Disabled" <?php if ($settings['latestposts_bar'] == 'Disabled') echo 'selected'; ?>>Off (Masquer)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><i class="fas fa-images text-primary"></i> Homepage Slider Type</label>
                                            <select name="homepage_slider" class="form-control">
                                                <option value="Featured" <?php if($settings['homepage_slider'] == 'Featured') { echo 'selected'; } ?>>Featured Posts Slider</option>
                                ...
                                <hr>
                                <h4><i class="fas fa-id-card"></i> Site logo</h4>
                                <div class="form-group">
                                    <?php if (!empty($settings['site_logo'])): ?>
                                        <div class="mb-2 p-2 bg-dark d-inline-block rounded">
                                            <img src="../<?php echo htmlspecialchars($settings['site_logo']); ?>" style="max-height: 50px;">
                                        </div>
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="delete_logo" value="Yes" id="delLogo">
                                            <label class="form-check-label text-danger" for="delLogo">Delete logo (revert to text)</label>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="fileLogo">Choose an image (Max height: 50px recommended)</label>
                                        </div>
                                    </div>
                                    <small class="text-muted">Formats: PNG (transparent recommended), JPG, SVG.</small>
                                </div>                                
                                <hr>
                            ...
                            <div class="tab-pane fade" id="tab-seo" role="tabpanel" aria-labelledby="tab-seo-link">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><i class="fas fa-heading text-primary"></i> Main title (Title & og:title)</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><i class="fas fa-align-left text-primary"></i> Meta Description (and og:description)</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fas fa-images text-primary"></i> Favicon URL</label>
                                            <input type="text" name="favicon_url" class="form-control" value="<?php echo htmlspecialchars($settings['favicon_url']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fab fa-apple text-primary"></i> Apple Touch Icon URL</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fas fa-user-edit text-primary"></i> Meta Author</label>
                                            <input type="text" name="meta_author" class="form-control" value="<?php echo htmlspecialchars($settings['meta_author']); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fas fa-cogs text-primary"></i> Meta Generator</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><i class="fas fa-robot text-primary"></i> Meta Robots</label>
                                ...
                                <h4><i class="fas fa-share-alt"></i> Social Networks</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="tab-security" role="tabpanel" aria-labelledby="tab-security-link">
                                <h4><i class="fas fa-map-marked-alt"></i> Google Maps</h4>
                                    <div class="form-group">
                                        <label>Integration Code (Iframe)</label>
                                        <textarea name="google_maps_code" class="form-control" rows="3" placeholder='<iframe src="https://www.google.com/maps/embed?..." ...></iframe>'><?php echo htmlspecialchars(base64_decode($settings['google_maps_code'])); ?></textarea>
                                        <small class="text-muted">Copy the iframe code provided by Google Maps here (Share > Embed).</small>
                                    </div>
                                <hr>                                
                                <h4><i class="fas fa-shield-alt"></i> Google reCAPTCHA v2</h4>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <hr>
                                <h4><i class="fas fa-code"></i> Custom Code Integration</h4>
                                <div class="form-group">
                                    <label><i class="fas fa-code text-warning"></i> Custom Code (Head)</label>
                                    ...
                                    <small class="text-muted">Add code (e.g., Google Analytics) just before the `&lt;/head&gt;` tag.</small>
                                </div>
                                <div class="form-group">
                                    <label><i class="fas fa-toggle-on text-success"></i> Enable Custom Code</label>
                                    <select name="head_customcode_enabled" class="form-control" required style="width: 200px;">
