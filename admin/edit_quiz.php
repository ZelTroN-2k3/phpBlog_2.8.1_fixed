...
if (!$quiz_data) {
    include 'header.php';
    echo '<section class="content"><div class="alert alert-danger">Quiz non trouvé.</div></section>';
    include 'footer.php';
    exit;
}
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Édition: <?php echo htmlspecialchars($quiz_data['title']); ?></h3>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="image">Remplacer l'image...</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="difficulty" name="difficulty">
                                    <option value="FACILE" <?php if ($quiz_data['difficulty'] == 'FACILE') echo 'selected'; ?>>Facile</option>
                                    <option value="NORMAL" <?php if ($quiz_data['difficulty'] == 'NORMAL') echo 'selected'; ?>>Normal</option>
                                    <option value="DIFFICILE" <?php if ($quiz_data['difficulty'] == 'DIFFICILE') echo 'selected'; ?>>Difficile</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="active" name="active">
                                    <option value="Yes" <?php if ($quiz_data['active'] == 'Yes') echo 'selected'; ?>>Publié (Active)</option>
                                    <option value="No" <?php if ($quiz_data['active'] == 'No') echo 'selected'; ?>>Brouillon (Inactive)</option>
                                </select>
                            </div>
                        </div>

                        <div class="card-footer">
                            <button type="submit" name="edit_quiz" class="btn btn-primary">Mettre à jour le Quiz</button>
                        </div>
                    </form>
                </div>
            </div>
