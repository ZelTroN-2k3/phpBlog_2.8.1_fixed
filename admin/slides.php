...
if (isset($_GET['delete_id'])) {
    ...
    if(mysqli_stmt_execute($stmt)) {
        $message = '<div class="alert alert-success">Diapositive supprimée.</div>';
    }
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-images"></i> Gestion du Slider</h1>
            </div>
            <div class="col-sm-6">
                <a href="add_slide.php" class="btn btn-primary float-right"><i class="fas fa-plus"></i> Nouvelle Diapositive</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body p-0">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php if(empty($slides)): ?>
                            <tr><td colspan="6" class="text-center text-muted py-4">Aucune diapositive créée.</td></tr>
                        <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="?delete_id=<?php echo $slide['id']; ?>&token=<?php echo $_SESSION['csrf_token']; ?>" 
                                           ...
                                           onclick="return confirm('Supprimer cette diapositive ?');">
