...
(1, 'Home', 'index', 'fas fa-home', 'Yes'),
(2, 'About', 'about', 'fas fa-info-circle', 'Yes'),
(3, 'Gallery', 'gallery', 'fas fa-images', 'Yes'),
(4, 'Posts', 'blog', 'fas fa-list', 'Yes'),
(5, 'Contact', 'contact', 'fas fa-envelope', 'Yes'),
(6, 'FAQ', 'faq', 'fas fa-question-circle', 'Yes'),
(7, 'Quiz', 'quiz', 'fas fa-graduation-cap', 'Yes'),
(8, 'Info', 'page?name=about', 'fas fa-info', 'No'),
(9, 'Legal Notice', 'legal-notice.php', 'fas fa-balance-scale me-2', 'No'),
(10, 'Privacy Policy', 'privacy-policy.php', 'fas fa-user-shield me-2', 'No');
