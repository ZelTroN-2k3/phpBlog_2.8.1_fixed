...
// À mettre TOUT EN HAUT de core.php
...
// --- FIN LOGIQUE POPUP ---
    ...
    if (isset($settings['cookie_consent_enabled']) && $settings['cookie_consent_enabled'] == 1) {
        $cookie_msg = !empty($settings['cookie_message']) ? $settings['cookie_message'] : "This site uses cookies to provide you with the best service. By continuing to browse the site, you agree to our use of cookies.";
    ?>
        <div id="cookieConsentBanner" class="fixed-bottom bg-dark text-white p-3 shadow-lg" style="display:none; z-index: 9999; border-top: 3px solid #0d6efd;">
            <div class="<?php echo ($settings['layout'] == 'Wide') ? 'container-fluid' : 'container'; ?>">
                <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                    ...
                    <div>
                        <button id="acceptCookiesBtn" class="btn btn-primary btn-sm fw-bold px-4">
        ...
        <script>
        document.addEventListener("DOMContentLoaded", function() {
            // Vérifier si l'utilisateur a déjà accepté (via localStorage)
            if (!localStorage.getItem("cookieConsentAccepted")) {
                // Afficher la bannière avec une petite animation
...
/**
 * Envoie un email en utilisant la configuration du site (SMTP ou Mail natif)
 *
 * @param string $to Email du destinataire
 * @param string $subject Sujet du message
 * @param string $body Contenu du message (HTML accepté)
 * @param string $altBody (Optionnel) Contenu texte brut pour les vieux clients mail
